...
export async function createNotification(data: { userId: number; matchId?: number; type: string; message: string }) {
...
export async function updateNotification(id: number, data: { read?: boolean; message?: string }) {
